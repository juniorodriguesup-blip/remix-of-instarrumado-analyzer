      ...
      <header className="border-b border-border/50 bg-background/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs px-3 py-1 rounded-full font-medium bg-instagram-pink/20 text-instagram-pink">
              Premium
            </span>
          </div>
          <Button
      ...
      <section className="py-12 md:py-16 border-b border-border/30">
        <div className="container mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-instagram-pink/10 border border-instagram-pink/30 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm font-medium text-instagram-pink">Acesso Liberado</span>
          </div>
          
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            Parabéns! Seu <span className="gradient-text">Instagram Profissional</span> começa agora.
          </h1>
      ...
      <section className="py-12 md:py-16 border-t border-border/30">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">
            Quer um diagnóstico <span className="gradient-text">personalizado</span>?
          </h2>
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
            Use nosso diagnóstico com IA para analisar seu perfil e receber recomendações específicas.
          </p>
          <Button
            size="lg"
